---
description: Creating and structuring Claude Code plugins with skills, agents, hooks
when_to_read: When creating plugins, adding components, or converting standalone to plugin
path: ./official/plugins/creating.md
---
