---
description: Commands extend Claude with slash commands and workflow triggers
when_to_read: When creating commands or understanding command vs skill precedence
path: ./official/commands.md
---
