---
description: Persistent memory architecture — CLAUDE.md hierarchy, .claude/rules/ scoping, path-specific rules, imports, and auto-memory
when_to_read: Before authoring CLAUDE.md files, configuring .claude/rules/, scoping rules with paths, importing files with @ syntax, or configuring auto-memory
path: ./official/memory.md
---
