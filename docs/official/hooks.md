---
description: Hook lifecycle events, locations, matcher patterns, and handler types
when_to_read: When configuring hooks, selecting events, or implementing hook handlers
path: ./official/hooks.md
---
