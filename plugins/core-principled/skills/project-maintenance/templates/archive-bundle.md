...
Structure for archived plan artifacts in `.principled/attic/{milestone}/{plan-id}/`.
...
**Learnings extracted:** {count} (see .principled/memory/learnings.md)
...
- **Copy, never move** — originals stay in `.principled/plans/phases/`
