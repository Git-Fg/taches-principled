...
**Audience:** anyone authoring or auditing `agents/*.md` in this marketplace.
...
1. **Static read** — read every `agents/*.md` and `skills/*/SKILL.md` in the plugin. Map the architecture. Identify the tool/contract surface.
