...
- **DOCUMENT mode**: IMMEDIATELY after implementation completes — BEFORE committing. Updates documentation to reflect completed code changes.
...
IF user asks to update docs, write README updates, or document recent changes → DOCUMENT
IF IMPLEMENT mode completes → route to DOCUMENT mode before Move Task to Done
...
- IMMEDIATELY after code changes affecting user-facing APIs or workflows
- AFTER IMPLEMENT mode completes and BEFORE committing
- When user explicitly asks to update documentation
