---
name: tdd
description: "Write tests first, then implementation. Add coverage to existing code, fix broken tests."
when_to_use: "Use when user asks to apply TDD, write the test first, add test coverage, or fix broken tests."
---
...
- CONTRAST with test: tdd handles execution (write tests, red-green-refactor, fix broken tests); test handles strategy (what to test, mocking decisions, fixture design). Use tdd when you know what to test; use test when deciding what to test.
