...
Write to `.principled/scratch/session-inspect-{uuid}.md`:
...
Write to `.principled/scratch/session-inspect-{uuid}.json`:
...
Write filtered output to `.principled/scratch/session-inspect-{uuid}-{filter}.jsonl`.
