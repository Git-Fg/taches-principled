...
|---|---|---|
| Plugin-shipped `.mcp.json` | `plugins/<name>/.mcp.json` | You're shipping the server as part of a Claude Code plugin. The plugin author controls config; the user opts in by installing the plugin. |
