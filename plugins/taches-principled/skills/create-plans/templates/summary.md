...
**1. [Bug/Missing Critical/Blocking] Brief description**
...
Logged to .principled/plans/ISSUES.md for future consideration:
...
**1. [Missing Critical] Added password hashing with bcrypt**
...
**2. [Blocking] Installed missing jose dependency**
