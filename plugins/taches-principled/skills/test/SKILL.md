...
when_to_use: "Use when user asks what to test, test coverage strategy, mocking approaches, or property-based testing."
argument-hint: "[mode] [target]"
---

## Routing Guidance

- CONTRAST with tdd: tdd teaches how to write tests (red-green-refactor); this skill teaches what decisions to make before writing tests. Use this skill for test strategy questions; use tdd for implementation execution.
