...
3. **Verify review file exists** — read from `.principled/scratch/meta-review-{session_id}.md`

### Process

1. **Privacy audit** — scan meta-review file, redact sensitive content
2. **Build issue body** — use template above, apply privacy scrub
3. **Write to temporary file** — `.principled/scratch/issue-body-{session_id}.md`
