...
- Now building: WeatherBar-iOS (separate Xcode project, different repo)
...
**Why**: Different codebase = different planning context.
...
2. Create MILESTONES.md entry
3. Update BRIEF with "Current State"
4. Reorganize ROADMAP with milestone grouping
5. Git tag v1.0
...
2. Add v1.1 entry to MILESTONES.md (prepended, newest first)
3. Update BRIEF current state to v1.1
4. Collapse phases 5-6 in ROADMAP
5. Git tag v1.1
...
## Task 1: Add MFA fields to User model
...
**What was built:** MFA enrollment flow
**How to verify:**
1. Run: npm run dev
...
| Mode | When | BRIEF | Phases | Plans |
|------|------|-------|--------|-------|
| Greenfield | v1.0 | Vision only | 1-4 | Create from scratch |
| Brownfield | v1.1+ | Current State + Goals | 5-6+ | Reference existing code |
| Archive | Different codebase | Fresh | Restart at 01 | Reference archived |
