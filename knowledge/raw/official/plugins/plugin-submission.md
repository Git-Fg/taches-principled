---
description: Submitting plugins to Claude's plugin directory and distribution options
when_to_read: When submitting plugins for distribution or choosing between directory/marketplace
path: ./official/plugins/plugin-submission.md
---
